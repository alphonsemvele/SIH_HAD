                ...
                <aside className={`fixed left-0 top-0 z-40 h-screen border-r border-[#1F1F28] bg-[#16161D] transition-all duration-300 ${sidebarCollapsed ? 'w-20' : 'w-72'}`}>
                    ...
                    <nav className="h-[calc(100vh-4rem)] overflow-y-auto p-4">
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="space-y-1">
                                <NavLink href="/admin/room" icon={<BuildingIcon />} active={isActive('/admin/room')} collapsed={sidebarCollapsed}>
                                    Chambre
                                </NavLink>
                                <NavLink href="/admin/services" icon={<LayersIcon />} active={isActive('/admin/services')} collapsed={sidebarCollapsed}>
                                    Services
                                </NavLink>
                                <NavLink href="/admin/tarifs" icon={<BanknoteIcon />} active={isActive('/admin/tarifs')} collapsed={sidebarCollapsed}>
                                    Tarification
                                </NavLink>
                                <NavLink href="/admin/patient" icon={<ShieldCheckIcon />} active={isActive('/admin/patient')} collapsed={sidebarCollapsed}>
                                    Patients
                                </NavLink>
                                <NavLink href="/admin/agenda" icon={<FileTextIcon />} active={isActive('/admin/agenda')} collapsed={sidebarCollapsed}>
                                    Agenda
                                </NavLink>
                            </ul>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="space-y-1">
                                <NavLink href="/admin/tickets" icon={<TicketIcon />} active={isActive('/admin/tickets')} collapsed={sidebarCollapsed}>
                                    Tickets support
                                </NavLink>
