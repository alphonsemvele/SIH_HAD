...
class PlanSoinsReevaluerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prestations.*.id' => ['nullable', 'exists:plan_soins_prestations,id'],
            'prestations.*.libelle' => ['required_without:prestations.*.id', 'string', 'max:255'],
            'prestations.*.frequence_type' => ['required_without:prestations.*.id', Rule::in(['ponctuelle', 'quotidienne', 'hebdomadaire', 'personnalisee'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'prestations.*.libelle.required_without' => 'Le libellé de la prestation est obligatoire pour une nouvelle prestation',
            'prestations.*.frequence_type.required_without' => 'Le type de fréquence est obligatoire pour une nouvelle prestation',
